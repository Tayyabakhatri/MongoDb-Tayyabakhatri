...
//         <>
//           <div className="my-20">
//             <p className="text-center font-bold text-6xl text-[#333333]">
//               SHOP
//             </p>
//           </div>
...
const Items = () => {
  ...
  <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">Your Cart, Your Choices – Ready to Checkout?</h3>
  <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:mt-8">
    <div class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      <div>
        ...
        <p class="mt-2 text-base text-gray-500 dark:text-gray-400">This generation has some improvements, including a longer continuous battery life.</p>
      </div>
      <div>
        <p class="text-lg font-bold text-gray-900 dark:text-white"><span class="line-through"> $399.99 </span></p>
        <p class="text-lg font-bold text-red-600 dark:text-red-500">$299</p>
      </div>
      <div class="mt-6 flex flex-wrap items-center gap-2.5">
        <button type="button" class="inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <button type="button" class="w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
          <svg class="me-2 h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24">
